...
const defaultProjects: ShowcaseProject[] = [
  {
    id: "elevatr",
    title: "Elevatr",
    description: "Placeholder project details. Click to open full project info.",
    year: "2026",
...
export function ProjectShowcase({
  ...
  return (
    <section ref={containerRef} onMouseMove={handleMouseMove} className="relative w-full max-w-3xl mx-auto px-6 py-16">
          ...
          >
            <div className="relative py-5 border-t border-border transition-all duration-300 ease-out">
              ...
              <div className="relative flex items-start justify-between gap-4">
                ...
                <span className={`text-xs font-mono text-muted-foreground tabular-nums transition-all duration-300 ease-out ${

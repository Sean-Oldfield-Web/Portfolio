...
const projectMenuData: ProjectMenuItem[] = [
  {
    ...
    summary:
      "Placeholder overview for the project. Add your final project summary here once screenshots are uploaded.",
    role: "Placeholder role",
    status: "Needs screenshots",
    primaryPlaceholder: "Main screenshot placeholder",
    secondaryPlaceholder: "Secondary screenshot placeholder",
  },
  {
    id: "flow-state",
    name: "Flow-State",
...
const caseStudiesByProject: Record<string, CaseStudy> = {
  elevatr: {
    id: "elevatr",
    quote: "Placeholder case study text for Elevatr. Replace with your final write-up and screenshots.",
    name: "Elevatr",
    role: "Your role: placeholder",
    image: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=900&auto=format&fit=crop&q=80",
    icon: "monitor",
    metrics: [
      { value: "40%", label: "Placeholder result", sub: "Update this metric later" },
      { value: "95%", label: "Placeholder adoption", sub: "Update this metric later" },
    ],
  },
  "flow-state": {
    id: "flow-state",
    quote: "Placeholder case study text for Flow-State. Replace with your final write-up and screenshots.",
    name: "Flow-State",
    role: "Your role: placeholder",
    image: "https://images.unsplash.com/photo-1517430816045-df4b7de11d1d?w=900&auto=format&fit=crop&q=80",
    icon: "dashboard",
    metrics: [
      { value: "3.5x", label: "Placeholder speed", sub: "Update this metric later" },
      { value: "70%", label: "Placeholder quality", sub: "Update this metric later" },
    ],
  },
  waveform: {
    id: "waveform",
    quote: "Placeholder case study text for Waveform. Replace with your final write-up and screenshots.",
    name: "Waveform",
    role: "Your role: placeholder",
    image: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=900&auto=format&fit=crop&q=80",
    icon: "users",
    metrics: [
      { value: "2x", label: "Placeholder retention", sub: "Update this metric later" },
      { value: "88%", label: "Placeholder feedback", sub: "Update this metric later" },
    ],
  },
  ptrn: {
    id: "ptrn",
    quote: "Placeholder case study text for Ptrn. Replace with your final write-up and screenshots.",
    name: "Ptrn",
    role: "Your role: placeholder",
    image: "https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?w=900&auto=format&fit=crop&q=80",
    icon: "monitor",
    metrics: [
      { value: "65%", label: "Placeholder completion", sub: "Update this metric later" },
      { value: "4.2x", label: "Placeholder consistency", sub: "Update this metric later" },
    ],
  },
};
